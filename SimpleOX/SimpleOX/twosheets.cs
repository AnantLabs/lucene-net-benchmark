...
namespace SimpleOX.Excel {
	public class twosheets {
		...
		private void GenerateWorkbookPart1Content( WorkbookPart workbookPart1 ) {
			...
			WorkbookView workbookView1 = new WorkbookView() { XWindow = 0, YWindow = 90, WindowWidth = (UInt32Value)28755U, WindowHeight = (UInt32Value)12585U, ActiveTab = (UInt32Value)1U };

			bookViews1.Append( workbookView1 );

			Sheets sheets1 = new Sheets();
			Sheet sheet1 = new Sheet() { Name = "Log", SheetId = (UInt32Value)1U, Id = "rId1" };
			Sheet sheet2 = new Sheet() { Name = "Sheet1", SheetId = (UInt32Value)2U, Id = "rId2" };
		...
		private void GenerateWorksheetPart1Content( WorksheetPart worksheetPart1 ) {
			...
			Selection selection1 = new Selection() { ActiveCell = "D3", SequenceOfReferences = new ListValue<StringValue>() { InnerText = "D3" } };
			...
			Cell cell4 = new Cell() { CellReference = "B2", DataType = CellValues.SharedString };
			CellValue cellValue4 = new CellValue();
			cellValue4.Text = "3";

			cell4.Append( cellValue4 );

			Cell cell5 = new Cell() { CellReference = "D2" };
			...
			Row row3 = new Row() { RowIndex = (UInt32Value)3U, Spans = new ListValue<StringValue>() { InnerText = "1:4" } };

			Cell cell6 = new Cell() { CellReference = "D3" };
			...
			PageSetup pageSetup1 = new PageSetup() { Orientation = OrientationValues.Portrait, HorizontalDpi = (UInt32Value)0U, VerticalDpi = (UInt32Value)0U };
		...
		private void GenerateWorksheetPart2Content( WorksheetPart worksheetPart2 ) {
			...
			SheetDimension sheetDimension2 = new SheetDimension() { Reference = "A1:A2" };

			SheetViews sheetViews2 = new SheetViews();

			SheetView sheetView2 = new SheetView() { WorkbookViewId = (UInt32Value)0U };
			Selection selection2 = new Selection() { ActiveCell = "A18", SequenceOfReferences = new ListValue<StringValue>() { InnerText = "A18" } };
			...
			Column column2 = new Column() { Min = (UInt32Value)1U, Max = (UInt32Value)1U, Width = 109.28515625D, Style = (UInt32Value)1U, CustomWidth = true };

			columns2.Append( column2 );

			SheetData sheetData2 = new SheetData();

			Row row4 = new Row() { RowIndex = (UInt32Value)1U, Spans = new ListValue<StringValue>() { InnerText = "1:1" } };

			Cell cell7 = new Cell() { CellReference = "A1", StyleIndex = (UInt32Value)1U, DataType = CellValues.SharedString };
			...
			Row row5 = new Row() { RowIndex = (UInt32Value)2U, Spans = new ListValue<StringValue>() { InnerText = "1:1" } };
			...
			PageSetup pageSetup2 = new PageSetup() { Orientation = OrientationValues.Portrait, HorizontalDpi = (UInt32Value)0U, VerticalDpi = (UInt32Value)0U, Id = "rId1" };
		...
		private void GenerateSharedStringTablePart1Content( SharedStringTablePart sharedStringTablePart1 ) {
			SharedStringTable sharedStringTable1 = new SharedStringTable() { Count = (UInt32Value)6U, UniqueCount = (UInt32Value)4U };

			SharedStringItem sharedStringItem1 = new SharedStringItem();
			Text text1 = new Text();
			text1.Text = "my string";

			sharedStringItem1.Append( text1 );

			SharedStringItem sharedStringItem2 = new SharedStringItem();
			Text text2 = new Text();
			text2.Text = "my string 2";
		...
		private void SetPackageProperties( OpenXmlPackage document ) {
			...
			document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime( "2011-02-16T23:34:51Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind );
