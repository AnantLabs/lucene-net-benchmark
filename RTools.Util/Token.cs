...
namespace RTools.Util
{
	...
	abstract public class Token
	{
		...
		public CharTypeBits type
		{
			get
			{
				if( this is WordToken )
				{
					return CharTypeBits.Word;
				} else if (this is CommentToken)
				{
					return CharTypeBits.Comment;
				} else if (this is EofToken)
				{
					return CharTypeBits.Eof;
				} else if (this is CharToken)
				{
					return CharTypeBits.Char;
				} else if (this is EolToken)
				{
					return CharTypeBits.Eol;
				} else if (this is FloatToken)
				{
					return CharTypeBits.Float;
				} else if (this is IntToken)
				{
					return CharTypeBits.Int;
				} else if (this is QuoteToken)
				{
					return CharTypeBits.Quote;
				} else if (this is StringToken)
				{
					return CharTypeBits.String;
				} else if (this is WhitespaceToken)
				{
					return CharTypeBits.Whitespace;
				} else
				{
					throw new Exception( "Could not find token type of token in Token.cs" );
				}
			}
		}
		/// <summary>
